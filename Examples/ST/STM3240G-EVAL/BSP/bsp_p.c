...
#define  BSP_GPIOD_LED2                        DEF_BIT_12
...
static void  BSP_LED_Init()
{
    ...
    BSP_PeriphEn(BSP_PERIPH_ID_GPIOD);                          /* Configure GPIOD for LED1, LED2, LED3 and LED4       */
...
* Description : Initialize any or all the LEDs on the board.
*
* Argument(s) : com     The ID of the common to control:
*
*                       1    inialize user COM1
*                       2    inialize user COM2
*                       3    inialize user COM3
*                       4    inialize user COM4
*
* Return(s)   : none.
*
* Caller(s)   : Application.
...
//#define  BSP_GPIOC_SEGMENTA                     DEF_BIT_13
//#define  BSP_GPIOC_SEGMENTB                     DEF_BIT_11
//#define  BSP_GPIOE_SEGMENTC                     DEF_BIT_07
//#define  BSP_GPIOA_SEGMENTD                     DEF_BIT_05
//#define  BSP_GPIOA_SEGMENTE                     DEF_BIT_01
//#define  BSP_GPIOD_SEGMENTF                     DEF_BIT_06
...
void  BSP_LED_On (CPU_INT08U  led)
{
    switch (led) {
        case 0u:
             HAL_GPIO_WritePin(GPIOD, (BSP_GPIOD_LED1 | BSP_GPIOD_LED2 | BSP_GPIOD_LED3 | BSP_GPIOD_LED4), GPIO_PIN_SET);
             break;


        case 1u:
             HAL_GPIO_WritePin(GPIOD, BSP_GPIOD_LED1, GPIO_PIN_SET);
             break;
...
void  BSP_LED_Off (CPU_INT08U led)
{
    switch (led) {
        case 0u:
             HAL_GPIO_WritePin(GPIOD, (BSP_GPIOD_LED1 | BSP_GPIOD_LED2 | BSP_GPIOD_LED3 | BSP_GPIOD_LED3), GPIO_PIN_RESET);
...
{
    CPU_INT08U seg_0, seg_a, seg_b, seg_c, seg_d, seg_e, seg_f, seg_g, seg_h;
  
    seg_0 = seg;
  
    if (seg_0 >= 128u) { seg_0 = seg_0 - 128u; seg_a = 1u; }
    if (seg_0 >= 64u) { seg_0 = seg_0 - 64u; seg_b = 1u; }
    if (seg_0 >= 32u) { seg_0 = seg_0 - 32u; seg_c = 1u; }
    if (seg_0 >= 16u) { seg_0 = seg_0 - 16u; seg_d = 1u; }
    if (seg_0 >= 8u) { seg_0 = seg_0 - 8u; seg_e = 1u; }
    if (seg_0 >= 4u) { seg_0 = seg_0 - 4u; seg_f = 1u; }
    if (seg_0 >= 2u) { seg_0 = seg_0 - 2u; seg_g = 1u; }
    if (seg_0 >= 1u) { seg_0 = seg_0 - 1u; seg_h = 1u; }
    ...
    switch (com) {
        case 1u:
             ...
             if (seg_a == 1u) { HAL_GPIO_WritePin(GPIOC, BSP_GPIOC_SEGMENTA, GPIO_PIN_SET); }
             if (seg_b == 1u) { HAL_GPIO_WritePin(GPIOC, BSP_GPIOC_SEGMENTB, GPIO_PIN_SET); }
             if (seg_c == 1u) { HAL_GPIO_WritePin(GPIOE, BSP_GPIOE_SEGMENTC, GPIO_PIN_SET); }
             if (seg_d == 1u) { HAL_GPIO_WritePin(GPIOA, BSP_GPIOA_SEGMENTD, GPIO_PIN_SET); }
             if (seg_e == 1u) { HAL_GPIO_WritePin(GPIOA, BSP_GPIOA_SEGMENTE, GPIO_PIN_SET); }
             if (seg_f == 1u) { HAL_GPIO_WritePin(GPIOD, BSP_GPIOD_SEGMENTF, GPIO_PIN_SET); }
             if (seg_g == 1u) { HAL_GPIO_WritePin(GPIOE, BSP_GPIOE_SEGMENTG, GPIO_PIN_SET); }
             if (seg_h == 1u) { HAL_GPIO_WritePin(GPIOC, BSP_GPIOC_SEGMENTH, GPIO_PIN_SET); }
             break;
        case 2u:
...
void  BSP_SEGMENT_Off (CPU_INT08U  com)
{
    switch (com) {
